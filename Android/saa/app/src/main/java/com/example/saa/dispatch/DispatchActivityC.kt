...
class DispatchActivityC : AppCompatActivity() {
    ...
    private val buttonIds = listOf(
        R.id.buttonStationC5 to "C5",
        R.id.buttonStationC4 to "C4",
        R.id.buttonStationC3 to "C3",
        R.id.buttonStationC2 to "C2",
        R.id.buttonStationC1 to "C1"
    )
    ...
    private fun loadSpinnerData() {
        CoroutineScope(Dispatchers.Main).launch {
            ...
            if (filteredPorts.isEmpty()) {
                ...
                val adapter = ArrayAdapter(this@DispatchActivityC, android.R.layout.simple_spinner_item, filteredPorts)
